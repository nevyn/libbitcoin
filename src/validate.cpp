...
bool validate_block::passes_checkpoints()
{
    ...
    if (height_ == 262835 && block_hash !=
            hash_digest{{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,
                        0x0f, 0x09, 0x60, 0x2f, 0xce, 0x52, 0x7f, 0x5d,
                        0x82, 0xe6, 0x80, 0x68, 0xaf, 0xd5, 0x4f, 0xfa,
                        0xa6, 0x45, 0x23, 0xca, 0x6f, 0x79, 0x82, 0x00}})
        return false;
